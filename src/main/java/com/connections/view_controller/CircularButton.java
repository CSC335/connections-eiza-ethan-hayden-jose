...
/**
 * The CircularButton class represents a customized button with circular styling.
 * It extends the JavaFX Button class and implements the Modular interface.
 */
public class CircularButton extends Button implements Modular {
    ...
    /**
     * Constructs a CircularButton object with the specified text, width, GameSessionContext, and fill style.
     *
     ...
     * @param fillStyle         a boolean indicating whether the button should have a fill style
     */
     ...
     * If the button has a fill style and is not disabled, it applies the submit button fill style.
     * Otherwise, it applies the regular button style.
     */
    @Override
