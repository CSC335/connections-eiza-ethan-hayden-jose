...
/**
 * Represents played game information for the timed game type.
 * Extends the PlayedGameInfo class and implements the DatabaseFormattable interface.
 * Adds additional properties specific to timed games, such as time limit and completion status.
 */
public class PlayedGameInfoTimed extends PlayedGameInfo implements DatabaseFormattable {
     ...
     * @param completedBeforeTimeLimit Indicates whether the game was completed before the time limit.
     ...
     *
     * @return The game type of the played game, which is always GameSession.GameType.TIME_TRIAL for this class.
     */
    @Override
