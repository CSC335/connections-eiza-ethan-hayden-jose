...
/**
 * Represents played game information for the classic game type.
...
public class PlayedGameInfoClassic extends PlayedGameInfo implements DatabaseFormattable {
     ...
     *
     * @return The game type of the played game, which is always GameSession.GameType.CLASSIC for this class.
     */
    @Override
